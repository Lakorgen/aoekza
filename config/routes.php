...
"news/" => "view-news.php",
"about/" => "view-company.php",
"partners/" => "view-partners.php",
"contacts/" => "view-contacts.php",
"requests/" => "view-requests.php",
"vacancy/" => "view-vacancy.php",
"about/sociallife/" => "view-sociallife.php",
"about/history/" => "view-history.php",
"about/managers/" => "view-managers.php",
"about/manufacture/" => "view-manufacture.php",
"works/" => "view-works.php",
);
?>