...
'AllowedFiles' => array('gif', 'jpg', 'jpeg', 'png', 'svg', 'zip', 'rar', 'gzip', 'txt', 'doc', 'docx', 'rtf', 
                        'sxc', 'sxw', 'vsd', 'wav', 'wma', 'wmv', 'xls','xlsx', 'xml', 'aiff','asf', 'avi', 'csv', 'mid', 
                        'mov', 'mp3', 'mp4', 'mpc', 'mpeg', 'mpg', 'pdf', 'ppt', 'pxd'),

//All allowed types of image files to upload
'AllowedImages' => array('gif', 'jpg', 'jpeg', 'png', 'svg'),

//Quality of .jpg images created by imagejpeg() of GD
'JpgQuality' => 90,

//Mime types to check for uploaded images
'DefaultImagesMimeTypes' => array('image/jpeg', 'image/gif', 'image/png', 'image/svg+xml'),
...
'ForbiddenModelsNames' => array('model','settings','users_logins','users_passwords',
