<? echo $mv -> seo -> displayMetaData("footer"); ?>
    <footer class="footer">
        ...
        <nav class="footer_nav">
            ...
            <div class="footer_contacts">
                ...
                <ul>
                    <li>
                        <a class="nav-link" href="mailto:secretary@aoekza.ru" class="contact__email">
    ...
    </svg>secretary@aoekza.ru</a>
                    </li>
                    <li>
                        <a class="nav-link" href="tel:+79999999999" class="contact__phone">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 20 20">
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z"/></svg>+7(999)-999-99-99</a>
                    </li>
                </ul>
            </div>
        </div>
