...
<link rel="stylesheet" type="text/css" href="<? echo $registry -> getSetting('AdminPanelPath'); ?>interface/css/style-filemanager.css<? echo $cache_drop; ?>" />
<script type="text/javascript" src="<? echo $registry -> getSetting('AdminPanelPath'); ?>interface/js/jquery.contextmenu.js"></script>
<script type="text/javascript" src="<? echo $registry -> getSetting('AdminPanelPath'); ?>interface/js/file-manager.js<? echo $cache_drop; ?>"></script>
